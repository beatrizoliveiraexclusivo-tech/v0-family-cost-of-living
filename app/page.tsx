    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center p-2 sm:p-4 md:p-8">
        ...
        >
          ...
          {/* Slide 4 - Impact on Families */}
          {currentSlide === 3 && (
            <div
              className={`h-full flex flex-col transition-all duration-700 overflow-y-auto ${
                isTransitioning ? "opacity-0 scale-95" : "opacity-100 scale-100"
              }`}
            >
              <div className="flex-1 p-4 sm:p-6 md:p-12 flex flex-col justify-center space-y-4 sm:space-y-6">
                <div className="flex items-center gap-2 sm:gap-3 animate-in slide-in-from-left duration-700">
                  <div className="h-6 sm:h-8 w-1 bg-amber-500"></div>
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">Impacto nas Famílias</h2>
                </div>

                <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-3 sm:space-y-4 animate-in slide-in-from-left duration-700 delay-200">
                    ...
                    <div className="bg-slate-800/50 rounded-lg p-3 sm:p-4 space-y-2">
                      <h3 className="text-base sm:text-lg font-semibold text-amber-400">Dados Alarmantes</h3>
                  ...
                  <div className="space-y-3 sm:space-y-4 animate-in slide-in-from-right duration-700 delay-300">
                    <div className="bg-slate-800/50 rounded-lg p-3 sm:p-5 border-l-4 border-red-500">
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2">Alimentação</h3>
                      <p className="text-xs sm:text-sm text-slate-300">
                    ...
                    <div className="bg-slate-800/50 rounded-lg p-3 sm:p-5 border-l-4 border-orange-500">
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2">Educação</h3>
                      <p className="text-xs sm:text-sm text-slate-300">
                    ...
                    <div className="bg-slate-800/50 rounded-lg p-3 sm:p-5 border-l-4 border-yellow-500">
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2">Saúde Mental</h3>
                      <p className="text-xs sm:text-sm text-slate-300">
          ...
          {currentSlide === 4 && (
            ...
            >
              <div className="flex-1 p-4 sm:p-6 md:p-12 flex flex-col justify-center space-y-4 sm:space-y-6">
                <div className="flex items-center gap-2 sm:gap-3 animate-in slide-in-from-left duration-700">
                  <div className="h-6 sm:h-8 w-1 bg-amber-500"></div>
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">Soluções e Perspectivas</h2>
                </div>
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                  <div className="bg-slate-800/50 rounded-lg overflow-hidden animate-in zoom-in duration-500 delay-200 hover:scale-105 transition-all">
                    ...
                    <div className="p-3 sm:p-5 space-y-2">
                      <h3 className="text-base sm:text-lg font-semibold text-amber-400">Políticas Públicas</h3>
                      <p className="text-xs sm:text-sm text-slate-300">
                  ...
                  <div className="bg-slate-800/50 rounded-lg overflow-hidden animate-in zoom-in duration-500 delay-300 hover:scale-105 transition-all">
                    ...
                    <div className="p-3 sm:p-5 space-y-2">
                      <h3 className="text-base sm:text-lg font-semibold text-amber-400">Educação Financeira</h3>
                      <p className="text-xs sm:text-sm text-slate-300">
                  ...
                  <div className="bg-slate-800/50 rounded-lg overflow-hidden animate-in zoom-in duration-500 delay-400 hover:scale-105 transition-all sm:col-span-2 md:col-span-1">
                    <div className="relative h-32 sm:h-40">
                      <img
                    ...
                    <div className="p-3 sm:p-5 space-y-2">
                      <h3 className="text-base sm:text-lg font-semibold text-amber-400">Cooperação Comunitária</h3>
                      <p className="text-xs sm:text-sm text-slate-300">
                ...
                <div className="bg-gradient-to-r from-amber-500/10 to-amber-500/5 rounded-lg p-4 sm:p-6 border border-amber-500/20 animate-in slide-in-from-bottom duration-700 delay-500">
                  <p className="text-xs sm:text-base text-slate-200 text-center leading-relaxed">
